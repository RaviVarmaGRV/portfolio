...
function BestFive({myBest}) {
    ...
    var bestFiveProjects = [
        {title:'Comment Section',description:"It’s a platform where users can comment, upvote, share their opinions, and easily delete their comments when needed.",languages:'NodeJs, Html Css and Javascript',img:'commentSection.png',link:'https://commentsection-t322.onrender.com/'},
        {title:'Chat bot',description:"It's a handy chatbot extension that gives you AI assistance anytime, anywhere.",languages:'React, Javascript and Gemini-api',img:'chatBotExtension.png',link:"https://github.com/RaviVarmaGRV/extension"},
